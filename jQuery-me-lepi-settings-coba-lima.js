...
/* Tampilan Head*/
function meOrange() {
    var x = document.getElementsByClassName("me-lepi-kehed setting-kehed");
    x[0].style.background = "orange";
    x[0].style.opacity = "0.6";
    x[0].style.filter = "alpha(opacity=60)";
    x[0].style.color = "#1d1d1d";
...
/* Tampilan Background*/
function meOrangeBG() {
    var x = document.getElementsByClassName("me-lepi-tengah setting-tengah");
    x[0].style.background = "orange";
}
function meCyanBG() {
    var x = document.getElementsByClassName("me-lepi-tengah setting-tengah");
...
/*Reset settings*/
function meResetAll() {
    var x = document.getElementsByClassName("me-lepi-tengah setting-kehed");
    x[0].style.background = "white ";
    x[0].style.color = "#1d1d1d";
	var x = document.getElementsByClassName("me-lepi-kehed setting-tengah");
    x[0].style.background = "orange";
    x[0].style.opacity = "0.6";
    x[0].style.filter = "alpha(opacity=60)";
    x[0].style.color = "#1d1d1d";
